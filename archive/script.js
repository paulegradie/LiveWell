...
function updateApartmentCalculation() {
    const totalHouseSaleProceeds = 1530000; // $2M house - $400k debt - $70k fees
    const mahnazShare = totalHouseSaleProceeds / 2; // Mahnaz gets half (765k)
    ...
    const leftoverFromSale = mahnazShare - apartmentCost;
...
function updateIrajCalculation() {
    const totalHouseSaleProceeds = 1530000; // $2M house - $400k debt - $70k fees
    const irajShare = totalHouseSaleProceeds / 2; // Iraj gets half (765k)
    const depositReturn = 60000;
    const totalAvailable = irajShare + depositReturn;
    const yearsToLast = 20;
